...
OPENSSL_ROOT=openssl-WARNING: Waiting 207 seconds for API quota reinstatement. ProTip: set GITHUB_API_TOKEN env var as per https://github.com/dvershinin/lastversion#tips
3.0.14
