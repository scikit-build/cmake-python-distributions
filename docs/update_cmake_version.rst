...
2. Execute `scripts/update_cmake_version.py` command line tool with the desired
   ``X.Y.Z`` CMake version available for download. For example::
    ...
    Collecting URLs and SHA256s from 'https://api.github.com/repos/Kitware/CMake/releases/tags/v3.29.1'
    [...]
    Collecting URLs and SHA256s from 'https://api.github.com/repos/Kitware/CMake/releases/tags/v3.29.1' - done
    Updating 'CMakeUrls.cmake' with CMake version 3.29.1
    Updating 'CMakeUrls.cmake' with CMake version 3.29.1 - done
